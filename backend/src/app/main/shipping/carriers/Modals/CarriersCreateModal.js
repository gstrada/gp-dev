...
function CarriersCreateModal({item, open, closeHandler}) {
    const dispatch = useDispatch();
    const loading = useSelector(({ShippingApp}) => ShippingApp.carrier.carrierCreateLoading);
    ...
    function handleSubmit() {
        dispatch(Actions.loadingCarrierCreate(true));
        dispatch(Actions.createCarrier(values));
        closeHandler();
    }
...
export default CarriersCreateModal;