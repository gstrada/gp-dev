...
function CitiesList({openDeleteAlertHandler, openDetailModalHandler, payment_method_state_id}) {

    const dispatch = useDispatch();
    const catalog = useSelector(({PaymentApp}) => PaymentApp.city.entities);
    const page = useSelector(({PaymentApp}) => PaymentApp.city.page);
    const loading = useSelector(({PaymentApp}) => PaymentApp.city.loading);
    ...
    useEffect(() => {
        ...
        dispatch(Actions.getCities(payment_method_state_id, page));
    ...
    function fetchData(state, table) {
        ...
        dispatch(Actions.getCities(payment_method_state_id, new_page));
    }
