...
import ProductPicturesDeleteAlert from "./Modals/ProductPicturesDeleteAlert";
import Button from "@material-ui/core/Button";
import Icon from "@material-ui/core/Icon";
import ProductPicturesCreateModal from "./Modals/ProductPicturesCreateModal";
...
function ProductPictures(props)
{
    ...
    function renderCreateModal() {
        if(openCreateModal){
            return <ProductPicturesCreateModal
    ...
    function renderDeleteAlert() {
        ...
        return <ProductPicturesDeleteAlert
...
export default withReducer('CatalogApp', reducer)(ProductPictures);
