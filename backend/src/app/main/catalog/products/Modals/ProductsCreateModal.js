...
import {createProduct} from "app/main/catalog/store/actions";
...
function ProductsCreateModal({item, open, closeHandler}) {
    ...
    function handleSubmit() {
        ...
        if (values && values.num_wp_reserva === null && values.metodo_reserva == '1') {
            alert('Por favor ingrese un número de teléfono para la reserva')

        } else if (values && values.alternativa_reserva === null && values.metodo_reserva == '3') {
                    ...
                    <div className={"flex-col w-full"}>
                        ...
                        <div className="flex flex-row flex-1 flex-shrink-0 mt-3 mb-3">
                            ...
                            <div className={"flex flex-row flex-1 flex-shrink-0"} style={{height: '53px'}}>
                                ...
                                >
                                    <option value="" >Seleccioná un método de reserva</option>
                        ...
                        <div className="flex flex-row flex-1 flex-shrink-0 mt-3 mb-3">
                            ...
                            <div className="flex flex-row flex-1 flex-shrink-0">
                                <TextField
                                    ...
                                    label="Cant. de personas recomendadas"
