...
function PacksCreateModal({item, open, closeHandler}) {

    let pictureInput = useRef(null);

    const dispatch = useDispatch();
    const loading = useSelector(({CatalogApp}) => CatalogApp.pack.packCreateLoading);
    ...
    function handleSubmit() {
        dispatch(Actions.loadingPackCreate(true));
        dispatch(Actions.createPack(values));
...
export default PacksCreateModal;
