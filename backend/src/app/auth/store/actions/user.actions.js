...
export function updateUserSegments(segments) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/segments`, {
            segments: segments
        });
...
export function updateUserLogo(logoFile) {
    return (dispatch) => {
        ...
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/logo`, form_data, {
            headers: {
...
export function updateUserEmail(email) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/email`, {
            email: email
        });
        request.then((response) => {
                if(response.data.code === 200){
...
export function updateUserPassword(old_password, password, password_confirmation) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/password`, {
...
export function updateUserName(name) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/name`, {
            name: name
        });
        request.then((response) => {
                if(response.data.code === 200){
...
export function updateUserPhone(phone) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/phone`, {
            phone: phone
        });
        request.then((response) => {
                if(response.data.code === 200){
...
export function updateUserWebsite(website) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/website`, {
            website: website
        });
        request.then((response) => {
                if(response.data.code === 200){
...
export function updateUserAddress(state, city, street_name, street_number, zip_code) {
    return (dispatch) => {
        const request = axios.post( `${AUTH_CONFIG.url}/api/retail/auth/profile/address`, {
            state: state,
            city: city,
