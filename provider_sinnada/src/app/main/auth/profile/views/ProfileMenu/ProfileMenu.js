        ...
        <FuseAnimate animation="transition.fadeIn" delay={300}>
            <div className={"w-full max-w-xl"}>
                ...
                <Card className="w-full max-w-xl">
                    <CardContent className="flex flex-col p-32 mt-1">
                        <List component="nav">
                            <ListItemMenu title='Nombre' icon='insert_drive_file' value={user.name} target='name' menuItemClick={menuItemClick}/>
                            <ListItemMenu title='Apellido' icon='insert_drive_file' value={user.lastname} target='lastname' menuItemClick={menuItemClick}/>
